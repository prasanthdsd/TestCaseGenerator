...
public class Query__1 {
    ...
    public String toString() {
        ...
        sb.append(Query__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("key");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Query__1) == false) {
            return false;
        }
        Query__1 rhs = ((Query__1) other);
