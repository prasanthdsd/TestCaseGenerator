...
public class Script__1 {
    ...
    public String toString() {
        ...
        sb.append(Script__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Script__1) == false) {
            return false;
        }
        Script__1 rhs = ((Script__1) other);
        return (((((((this.src == rhs.src)||((this.src!= null)&&this.src.equals(rhs.src)))&&((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))))&&((this.exec == rhs.exec)||((this.exec!= null)&&this.exec.equals(rhs.exec))));
    }
