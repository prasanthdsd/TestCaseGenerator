...
public class Header__1 {
    ...
    public String toString() {
        ...
        sb.append(Header__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("key");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Header__1) == false) {
            return false;
        }
        Header__1 rhs = ((Header__1) other);
