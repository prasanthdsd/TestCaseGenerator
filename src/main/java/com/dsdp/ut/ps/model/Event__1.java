...
public class Event__1 {
    ...
    public String toString() {
        ...
        sb.append(Event__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Event__1) == false) {
            return false;
        }
        Event__1 rhs = ((Event__1) other);
        return ((((((this.disabled == rhs.disabled)||((this.disabled!= null)&&this.disabled.equals(rhs.disabled)))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.listen == rhs.listen)||((this.listen!= null)&&this.listen.equals(rhs.listen))))&&((this.script == rhs.script)||((this.script!= null)&&this.script.equals(rhs.script))));
    }
