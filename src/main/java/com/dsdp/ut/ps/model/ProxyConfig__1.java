...
public class ProxyConfig__1 {
    ...
    public String toString() {
        ...
        sb.append(ProxyConfig__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("match");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProxyConfig__1) == false) {
            return false;
        }
        ProxyConfig__1 rhs = ((ProxyConfig__1) other);
        return (((((((this.port == rhs.port)||((this.port!= null)&&this.port.equals(rhs.port)))&&((this.match == rhs.match)||((this.match!= null)&&this.match.equals(rhs.match))))&&((this.host == rhs.host)||((this.host!= null)&&this.host.equals(rhs.host))))&&((this.disabled == rhs.disabled)||((this.disabled!= null)&&this.disabled.equals(rhs.disabled))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.tunnel == rhs.tunnel)||((this.tunnel!= null)&&this.tunnel.equals(rhs.tunnel))));
    }
