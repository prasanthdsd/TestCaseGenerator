...
public class Info__1 {
    ...
    public String toString() {
        ...
        sb.append(Info__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__1) == false) {
            return false;
        }
        Info__1 rhs = ((Info__1) other);
        return (((((((this.schema == rhs.schema)||((this.schema!= null)&&this.schema.equals(rhs.schema)))&&((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name))))&&((this.description == rhs.description)||((this.description!= null)&&this.description.equals(rhs.description))))&&((this.postmanId == rhs.postmanId)||((this.postmanId!= null)&&this.postmanId.equals(rhs.postmanId))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.version == rhs.version)||((this.version!= null)&&this.version.equals(rhs.version))));
    }
