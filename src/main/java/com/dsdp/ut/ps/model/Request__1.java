...
public class Request__1 {
    ...
    public String toString() {
        ...
        sb.append(Request__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("url");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Request__1) == false) {
            return false;
        }
        Request__1 rhs = ((Request__1) other);
