...
public class Variable__1 {
     ...
     */
    @JsonProperty("type")
    public Variable__1 .Type getType() {
        return type;
    }
     ...
     */
    @JsonProperty("type")
    public void setType(Variable__1 .Type type) {
        this.type = type;
    }
    ...
    public String toString() {
        ...
        sb.append(Variable__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Variable__1) == false) {
            return false;
        }
        Variable__1 rhs = ((Variable__1) other);
        return ((((((((((this.system == rhs.system)||((this.system!= null)&&this.system.equals(rhs.system)))&&((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name))))&&((this.description == rhs.description)||((this.description!= null)&&this.description.equals(rhs.description))))&&((this.disabled == rhs.disabled)||((this.disabled!= null)&&this.disabled.equals(rhs.disabled))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))))&&((this.value == rhs.value)||((this.value!= null)&&this.value.equals(rhs.value))))&&((this.key == rhs.key)||((this.key!= null)&&this.key.equals(rhs.key))));
    }
    ...
    public enum Type {
        ...
        private final static Map<String, Variable__1 .Type> CONSTANTS = new HashMap<String, Variable__1 .Type>();

        static {
            for (Variable__1 .Type c: values()) {
        ...
        @JsonCreator
        public static Variable__1 .Type fromValue(String value) {
            Variable__1 .Type constant = CONSTANTS.get(value);
            if (constant == null) {
