...
public class Auth {
    ...
    public String toString() {
        ...
        sb.append("edgegrid");
        sb.append('=');
        sb.append(((this.edgegrid == null)?"<null>":this.edgegrid));
        sb.append(',');
        sb.append("hawk");
        sb.append('=');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.edgegrid == null)? 0 :this.edgegrid.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        Auth rhs = ((Auth) other);
        return ((((((((((((((this.apikey == rhs.apikey)||((this.apikey!= null)&&this.apikey.equals(rhs.apikey)))&&((this.edgegrid == rhs.edgegrid)||((this.edgegrid!= null)&&this.edgegrid.equals(rhs.edgegrid))))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))))&&((this.oauth2 == rhs.oauth2)||((this.oauth2 != null)&&this.oauth2 .equals(rhs.oauth2))))&&((this.oauth1 == rhs.oauth1)||((this.oauth1 != null)&&this.oauth1 .equals(rhs.oauth1))))&&((this.ntlm == rhs.ntlm)||((this.ntlm!= null)&&this.ntlm.equals(rhs.ntlm))))&&((this.awsv4 == rhs.awsv4)||((this.awsv4 != null)&&this.awsv4 .equals(rhs.awsv4))))&&((this.noauth == rhs.noauth)||((this.noauth!= null)&&this.noauth.equals(rhs.noauth))))&&((this.digest == rhs.digest)||((this.digest!= null)&&this.digest.equals(rhs.digest))))&&((this.bearer == rhs.bearer)||((this.bearer!= null)&&this.bearer.equals(rhs.bearer))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.basic == rhs.basic)||((this.basic!= null)&&this.basic.equals(rhs.basic))))&&((this.hawk == rhs.hawk)||((this.hawk!= null)&&this.hawk.equals(rhs.hawk))));
    }
